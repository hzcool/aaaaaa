...
var Contest = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, syzoj.utils.lock(['Contest::newSubmission', this.id], function () { return __awaiter(_this, void 0, void 0, function () {
                                var player;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
    ...
    __decorate([
        TypeORM.Column({ nullable: true, type: "boolean" }),
        __metadata("design:type", Boolean)
    ], Contest.prototype, "hide_username");
    __decorate([
        TypeORM.Column({ nullable: true, type: "text" }),
        __metadata("design:type", String)
    ], Contest.prototype, "group_id");
    Contest = __decorate([
        TypeORM.Entity()
    ], Contest);
    return Contest;
